import { validationResult } from "express-validator";import { jsonGenerate } from "../utils/helpers.js";
...
export const MarkTodo = async (req, res) => {
    ...
    try{
        ...
        return res.json(jsonGenerate(StatusCode.UNPROCESSABLE_ENTITY,"could not update", todo));
